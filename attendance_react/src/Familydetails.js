...
<Grid container spacing={1}>
                  ...
                  {addplus.map((_, index) => (
                    <React.Fragment key={index}>
                      ...
                      <Grid item sm={12} xs={12} >
                        <label for="kidname" class="block mb-2 text-sm font-medium text-gray-900 ">Kid Name &nbsp;<span  class="text-red-600 text-xl"></span></label>
            ...
            focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 
             ...
             onBlur={(e)=> {const kid_edit= values.kid_name.split("||")
                       kid_edit[index]=e.target.value
              SetValues({...values, kid_name:kid_edit.join("||")})}}
              ...
              onBlur={(e)=> {const kid_edit= values.kid_dob.split("||")
                       kid_edit[index]=e.target.value
              SetValues({...values, kid_dob:kid_edit.join("||")})}}
              ...
              name  ="kid_dob"
                      ...
                      <Grid item sm={1} xs={1}>
                        {index===0? <AddIcon onClick={handleAddField} style={{ color: '#0072bc', marginTop: '35px' }} />:<RemoveIcon onClick={() => handleRemoveField(index)} style={{ color: '#0072bc', marginTop: '35px' }} />}
                      </Grid>
