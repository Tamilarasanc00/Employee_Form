        ...
        <CardContent>
          <form onSubmit={handlesubmit}>
            ...
            <div>
              ...
              <div>
                <label for="UG Qualification " class="block mb-2 text-sm font-medium text-gray-900">% Marks&nbsp;<span  class="text-red-600 text-xl">*</span></label>
                <input type="text" id="UG Percentage " class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="% Percentage" name="hsc_percentage" onChange={handleChange} required
                   />
              </div>
              ...
              <div>
                ...
                <input type="text" id="UG Percentage " placeholder="% Percentage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" name="ug_qualification_percentage" onChange={handleChange}
                   />
              </div>
              ...
              <div>
                ...
                <input type="text" id="PG Percentage " placeholder="% Percentage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" name="pg_qualification_percentage" onChange={handleChange}
                   />
              </div>
