...
[]) 
  ...
  console.log(id);
    ...
    const  handlefacilityTypeChange = (e,index,index2) =>{
      

      const value = e.target.value;
const fctl=addFacilities.facility_type?addFacilities.facility_type:""
const step1=[...fctl.split("|")]
const step2=step1[index]?step1[index].split(','):[]
if(step2.includes(value)){
step2.filter((i)=>i!==value)
}else{
   step2.push(value)
}

 step1[index]=step2.joins(',')
fctl=step1.joins("|")
console.log(fctl);
      setAddFacilities({
        ...addFacilities,
...
<div class="flex items-center mb-5"  style={{marginTop:"25px"}}>
    ...
    <div >
                  ...
                  value={values.number_verified ? values.direct_no : values.aadhar_linkedno}
    ...
    name = "licence"
    checked={addFacilities.facility.includes('licence')}
  />
...
{addFacilities.facility.includes('licence') && (
...
<div class="flex items-center mb-4">
                  <input id="vehicle" type="checkbox" value="vehicle" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" name = "vehicle" onChange={(e)=>{handleCheckboxChange(e)}}
   ...
   <div className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
     <label>
       <input
         ...
         value="twoWheeler"
         //checked={facilityTypes.twoWheeler}
         onChange={(e)=>{handlefacilityTypeChange(e,2,0)}}
       />&nbsp;
       Two Wheeler
     </label>
     &nbsp;&nbsp;
     <label>
       <input
         ...
         value="fourWheeler"
         //checked={facilityTypes.fourWheeler}
         onChange={(e)=>{handlefacilityTypeChange(e,2,1)}}
       />&nbsp;
       Four Wheeler
     </label>
   </div>
